...
#import "JCDDetailViewController.h"
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (JCDDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
